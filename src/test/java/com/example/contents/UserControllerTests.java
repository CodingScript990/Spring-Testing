...
import com.example.contents.controller.UserController;
...
public class UserControllerTests {
    ...
    // Controller 가 있을때 HTTP 요청이 보내졌다는 가정해주는 객체
    ...
    @Test
    @DisplayName("UserDto 를 나타내는 JSON 요청을 보내면 id 가 null 이 아닌 UserDto JSON 응답")
    public void testCreate() throws Exception {
        ...
        // 3. userService.createUser 의 동작 가장
        ...
        result.andExpectAll(
                ...
                jsonPath("$.id", notNullValue()) // id 는 null 은 아닌 값
        );
    }
}
